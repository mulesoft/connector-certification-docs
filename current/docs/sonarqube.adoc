...
Note: For guidelines on how to build your tests using this framework, see http://mulesoft.github.io/connector-certification-docs/current/user-manual.html#_automated_functional_testing[Automated Functional Testing].
...
. Download and extract https://drive.google.com/open?id=0B8N265C555thQWNPYkQ4cnFBQlU&authuser=0[our SonarQube 4.5 distribution] (all platforms). This includes our custom quality profile and everything you need to get started.
