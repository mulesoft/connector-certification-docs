...
*** https://www.mulesoft.com/library#!/salesforce-integration-connector?types=connector[SalesForce Connector] could be use a template example. 
...
Finally, the connector will be available in https://www.mulesoft.com/library[MuleSoft Connector Library]
