...
* Use a meaningful name for the project. Avoid things such as "MyConnector Demo". This name will be displayed in the ApiDoc site. Eg: http://mulesoft.github.io/salesforce-connector/
* Project folder name should be in lower case.
