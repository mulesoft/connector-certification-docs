...
If you still need that custom library that collides with mule, then shading could work for you. The support for shading has been added in devkit 3.5.2.
...
<dependencies>
    <dependency>
        ...
        <artifactId>custom-artefact-id</artifactId>
