...
include::docs/static-code-analysis-using-sonarqube.adoc[]
...
= Run Interop Tests using DevKit Plugin
---

include::docs/devkit-plugin-run-interop-tests-action.adoc[]

// [functional-test-plugin]
= Generate Test Data using DevKit Plugin
---

include::docs/devkit-plugin-generate-test-data-action.adoc[]
