...
[[documentation]]
= Development: Connector Release Notes & Documentation
...
This section gathers different templates used though out the development stage.

[[documentation-templates]]
== Anypoint™ Connectors Documentation Templates
...
== Functional Tests Automation Template

* link:attachments/debugging.html[Debugging]


== Anypoint™ Studio Interoperability Testing Template
