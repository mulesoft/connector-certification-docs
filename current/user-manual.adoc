...
* link:attachments/documentationTemplate.adoc[Documentation Template]

* link:attachments/readme.adoc[README.md Template]

* link:attachments/project-directory-layout.adoc[Connector Project Directory Layout]

// * link:attachments/[Appendix C] TODO missing appedix?

* link:attachments/CPAL.adoc[Common Public Attribution License Version 1.0 (CPAL)]


== Appendix B: Functional Tests Automation

* link:attachments/debugging.adoc[Debugging]

== Appendix C: Anypoint Studio Interoperability Testing

* link:attachments/usage-without-anypoint-studio.adoc[Usage without Anypoint Studio]
* link:attachments/plugin-result-files.adoc[Plugin Result Files]
* link:attachments/project-details.adoc[Project Details]

== Appendix D: Anypoint Connectors Release Notes Template

link:attachments/releaseNotesTemplate.adoc[Release Notes Template]
