...
* attachments/debugging.adoc[Debugging]

== Appendix C: Anypoint Studio Interoperability Testing

* attachments/usage-without-anypoint-studio.adoc[Usage without Anypoint Studio]
* attachments/plugin-result-files.adoc[Plugin Result Files]
* attachments/project-details.adoc[Project Details]
